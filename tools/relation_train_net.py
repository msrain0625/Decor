...
torch.cuda.set_per_process_memory_fraction(0.47, device=0)

try:
    from apex import amp
    APEX_AVAILABLE = True
except ImportError:
    print("Warning: apex not available. Using PyTorch native AMP instead.")
...
def train(
    ...
    if APEX_AVAILABLE and use_mixed_precision:
